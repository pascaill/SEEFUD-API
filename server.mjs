...
import { register, login, logout, updateProfile, deleteAccount } from './routes/auth.mjs';
...
app.get('/umkm-dashboard', authenticateToken, authorizeRole('pemilik_umkm'), (req, res) => {
